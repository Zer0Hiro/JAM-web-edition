const lesson01 = {
  ...
  phase: 1,
  difficulty: 1,
  goal: "!כתבו את תוכנית ה-JEM הראשונה שלכם ושמעו צליל יוצא",
  ...
  steps: [
    {
      title: "?מה זה JEM",
      content: `JEM מאפשר ליצור מוזיקה על ידי הקלדת מילים. אתם מקלידים, והוא מנגן. כמו לשלוח הודעה לרובוט שמייצר צלילים בשבילכם!
...
- **VOLUME 200** -- כמה חזק (מקסימום 255)`,
    ...
    {
      title: "בחרו תווים",
      content: `תגידו ל-JEM אילו תווים לנגן:
...
בלי השורה הזו, JEM יודע את השיר שלכם אבל לא ינגן אותו. זה כמו לכתוב מתכון אבל לשכוח לבשל!`,
    },
  ],
