const he = {
  ...
  sandbox: {
    ...
    structureItems: ["CUTOFF / RESONANCE -- מסנן", "REVERB -- אווירת חדר (0-255)", "DELAY זמן פידבק -- הד", "GLIDE ms -- גלישה בין תווים", "PAN 0-255 (שמאל/מרכז/ימין)", "VOLUME באמצע שיר -- אוטומציה"],
  },
