const he = {
  ...
  phases: {
    ...
    5: { title: "עיצוב צליל", description: "הוסיפו אפקטים, מרחב ותנועה למוזיקה" },
    6: { title: "טכניקות מתקדמות", description: "שלטו בסולמות, גרוב, פיידים ומודלים פיזיקליים" },
  },
  ...
  editor: {
    ...
    downloadWav: "WAV",
    renderingWav: "...מעבד WAV באיכות מלאה",
    renderEta: "נשארו בערך {s} שניות",
    renderEstimating: "...מעריך",
    renderCancel: "ביטול",
    renderFailed: "עיבוד ה-WAV נכשל",
    viewCpp: "C++",
    generatedCpp: "קוד Mozzi C++ שנוצר — מוכן ל-ESP32",
    copyCpp: "העתקה",
    uploadBoard: "העלאה",
    selectBoard: "בחר לוח יעד",
    boardEsp32: "ESP32",
    boardArduino: "Arduino Uno",
    selectPin: "בחר פין פלט",
    uploadingBoard: "...{board}-מעלה ל",
    uploadSuccess: "!{board} רץ על",
    uploadFailed: "ההעלאה נכשלה",
    uploadOffline: "העלאה לא זמינה",
  ...
  sandbox: {
    ...
    waveforms: "צורות גל",
    notes: "תווים",
    structure: "אפקטים ושליטה",
    waveformItems: ["SIN -- חלק, נקי", "SAW -- זמזומי, בהיר", "SQUARE -- רטרו, חלול", "TRIANGLE -- עדין, רך", "NOISE -- אקראי, כלי הקשה", "PLUCK -- מיתרי, דועך", "HANDPAN -- מתכתי, מהדהד"],
    noteItems: ["C4 = דו אמצעי (A4 = 440 הרץ)", "C#4 / Db4 = דיאזים/במולים", "משך: 0.25 עד 4 פעימות", "עוצמה: 0-255 אחרי משך", "אקורדים: [C4 E4 G4]"],
    structureItems: ["CUTOFF / RESONANCE -- מסנן", "REVERB -- אווירת חדר (0-255)", "DELAY זמן פידבק -- הד", "GLIDE ms -- גלישה בין תווים", "PAN 0-255 (שמאל/מרכז/ימין)", "VOLUME באמצע שיר -- אוטומציה", "KEY שורש סולם -- נעילה לסולם", "SWING 0-100 -- תחושת שאפל", "HUMANIZE 0-50 -- תזמון אנושי", "FADE_IN / FADE_OUT פעימות -- רמפת ווליום", "LFO קצב עומק VOLUME|PITCH -- מודולציה", "VOICES 1-4 / DETUNE 0-100 -- עובי יוניסון", "CHORUS 0-255 -- רוחב סטריאו", "REVERB:ערך / DELAY:ז:פב -- אפקט לפי תו"],
  },
  ...
  soundLibrary: {
    ...
    waveComparison: "צורות גל קלאסיות",
    waveComparisonSub: "אבני הבניין של סינתזה — העבירו עכבר או לחצו על כל כרטיס כדי לשמוע.",
    specialWaves: "מנועי סינתזה",
    specialWavesSub: "מחוללי צליל מתקדמים שחורגים מצורות גל פשוטות — מודלינג פיזיקלי, סינתזה אדיטיבית ועוד.",
    playing: "...מנגן",
    hearIt: "שמעו",
    ...
    waveDescs: {
      ...
      pluck: "התקפה חדה שדועכת באופן טבעי — כמו פריטה על מיתר גיטרה או נבל. משתמש בסינתזת Karplus-Strong!",
      handpan: "ממברנת מתכת שנחבטת ומהדהדת עם הרמוניות — כמו הנדפאן או תוף לשון פלדה. שכבות של על-תדרים יוצרות נצנוץ חם דמוי פעמון.",
      bell: "צליל נקי ומצלצל — כמו פעמון או צ׳יימ שנחבט. סינוס בסיסי עם הרמוניות עליונות שדועכות מהר נותן את האופי הקלאסי של \"דינג\".",
    },
  },
